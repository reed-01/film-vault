...
public class TestingDatabaseConfig {
    ...
    private static final String DB_NAME =
            Objects.requireNonNullElse(System.getenv("DB_NAME"), "film_vault_test");
    private static final String DB_USERNAME =
            Objects.requireNonNullElse(System.getenv("DB_USERNAME"), "postgres");
    private static final String DB_PASSWORD =
            Objects.requireNonNullElse(System.getenv("DB_PASSWORD"), "$!$island414#$#orange545!#!lasagna323");
    ...
    public void setup() {
        if (System.getenv("DB_HOST") == null) {
            ...
            adminDataSource.setPassword("$!$island414#$#orange545!#!lasagna323");
