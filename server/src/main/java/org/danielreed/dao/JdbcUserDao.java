...
public class JdbcUserDao implements UserDao {
    ...
    public User createUser(User newUser) {
        ...
        String insertUserSql = "INSERT INTO users " +
                "(username, password_hash, role, name, address, city, state_code, zip_code) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?) " +
                "RETURNING user_id";
        ...
        try {
            ...
            Integer userId = jdbcTemplate.queryForObject(insertUserSql, int.class,
                    newUser.getUsername(), passwordHash, newUser.getRole(), newUser.getName(), newUser.getAddress(), newUser.getCity(), newUser.getStateCode(), newUser.getZipCode());
